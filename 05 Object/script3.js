...
// immediately invoked function expression (IIFE) dung cho so 7
(function(){
    ...
    Question.prototype.displayQuestion = function() {
        ...
        for (var key in this.answersPlayer) {
            console.log(this.answersPlayer[key]);
        }
    }
    
    Question.prototype.checkAnswer = function(answerPlayer, callback) {
        var sc;
        if(this.correctAnswer === answerPlayer) {
    ...
    function nextQuestion() {
        ...
        questions[showNumberQuestion].displayQuestion();
        
        var answer = prompt("Please select the correct answer");
        
        if(answer !== 'exit') {
            questions[showNumberQuestion].checkAnswer(parseInt(answer), keepScore);
            nextQuestion();
        }
